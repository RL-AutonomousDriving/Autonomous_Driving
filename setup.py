...
setup(
    name='highway-env',
    version='1.0.dev0',
    description='A Highway environment for autonomous driving tasks',
    url='https://github.com/RL-AutonomousDriving/Autonomous_Driving',
    author='Edouard Leurent',
    author_email='sivaranjani.kumar@sjsu.edu',
    license='MIT',
    classifiers=[
